...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.chatImportsList]: AuthOrchestrationReadScope,
  [WS_METHODS.chatImportsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.chatImportsGetLinked]: AuthOrchestrationReadScope,
  [WS_METHODS.chatImportsSetStatus]: AuthOrchestrationOperateScope,
  [WS_METHODS.chatImportsRefresh]: AuthOrchestrationReadScope,
  [WS_METHODS.chatImportsLiveSyncStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.chatImportsInstallLiveSync]: AuthOrchestrationOperateScope,
  [WS_METHODS.chatImportsUninstallLiveSync]: AuthOrchestrationOperateScope,
  [WS_METHODS.chatImportsAdopt]: AuthOrchestrationOperateScope,
  [WS_METHODS.chatImportsResolveConflict]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscribeChatImports]: AuthOrchestrationReadScope,
